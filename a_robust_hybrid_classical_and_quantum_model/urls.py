"""a_robust_hybrid_classical_and_quantum_model URL Configuration
...
from a_robust_hybrid_classical_and_quantum_model import settings
...
urlpatterns = [
    ...
    url(r'^Predict_wind_speed_forecasting/$', remoteuser.Predict_wind_speed_forecasting, name="Predict_wind_speed_forecasting"),
    ...
    url(r'^View_Prediction_Of_wind_speed_forecasting_Ratio/$', serviceprovider.View_Prediction_Of_wind_speed_forecasting_Ratio, name="View_Prediction_Of_wind_speed_forecasting_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_wind_speed_forecasting/$', serviceprovider.View_Prediction_Of_wind_speed_forecasting, name="View_Prediction_Of_wind_speed_forecasting"),
